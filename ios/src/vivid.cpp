...
void vivid(char *path,char *returnPath)
{
    ...
    lab[1] = lab[1] -
             ((aAvg - 125) * (lab[0] / 255.0) * 1.1);

    lab[2] = lab[2] -
             ((bAvg - 125) * (lab[0] / 255.0) * 1.1);
    ...
    bgr[0] = (bgr[0] - vmin_b) * 255 / (vmax_b - vmin_b) * 1.4;
    bgr[1] = (bgr[1] - vmin_g) * 255 / (vmax_g - vmin_g) * 1.1;
    bgr[2] = (bgr[2] - vmin_r) * 255 / (vmax_r - vmin_r) * 1.4;
